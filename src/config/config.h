...
#define CMD_HIGH_LEVEL_RADIO_TASK_PRI 2
#define CMD_HIGH_LEVEL_EVAL_TASK_PRI  2
...
#define CMD_HIGH_LEVEL_RADIO_TASK_NAME "CMDHL-RADIO"
#define CMD_HIGH_LEVEL_EVAL_TASK_NAME  "CMDHL-EVAL"
...
#define CMD_HIGH_LEVEL_RADIO_TASK_STACKSIZE (2 * configMINIMAL_STACK_SIZE)
#define CMD_HIGH_LEVEL_EVAL_TASK_STACKSIZE  (3 * configMINIMAL_STACK_SIZE)
